...
// in flutter_clean_architecture_with_provider_template/test/core/services/notification/local_notif_service_test.dart.
...
import 'local_notif_service_test.dart' as _i11;
...
class MockInitializationSettings extends _i1.Mock
    implements _i4.InitializationSettings {
...
class MockNotificationResponse extends _i1.Mock
    implements _i5.NotificationResponse {
  MockNotificationResponse() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.NotificationResponseType get notificationResponseType =>
      (super.noSuchMethod(
        Invocation.getter(#notificationResponseType),
        returnValue: _i5.NotificationResponseType.selectedNotification,
      ) as _i5.NotificationResponseType);
}

/// A class which mocks [NotificationResponseCallback].
///
/// See the documentation for Mockito's code generation for more information.
class MockNotificationResponseCallback extends _i1.Mock
    implements _i11.NotificationResponseCallback {
  MockNotificationResponseCallback() {
    _i1.throwOnMissingStub(this);
  }

  @override
  void call(_i5.NotificationResponse? response) => super.noSuchMethod(
        Invocation.method(
          #call,
          [response],
        ),
